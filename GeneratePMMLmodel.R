...
colnames(mydata) <- c("dateTime", "name", "lastPrice", "lastPriceLag", "SMA10", "SMA100", "SMA_signal", "SMA_direction","BB_lowerbound", "BB_upperbound", "Bollinger Band", "BB_signal", "BB_direction","CCI", "CCI_signal", "CCI_direction",
...
vreturnTable <- na.omit(returnTable)
...
plot_ly( data = resultDF, x = Period, y = ~Return2, type = "scatter", mode = "markers", marker = list(size = 7), name = 'Treshold 0.10') %>%
  layout(xaxis = x, yaxis = y ,title = 'One day deployment period')%>% 
  add_trace(data = resultDF, x = Period, y = ~Return, type = "scatter", mode = "markers", marker = list(size = 7),  name = 'Treshold 0.01')%>% 
  add_trace(data = resultDF, x = Period, y = ~Return3, type = "scatter", mode = "markers", marker = list(size = 7),  name = 'Treshold 0.20')%>% 
  add_trace(data = resultDF, x = Period, y = ~Return4, type = "scatter", mode = "markers", marker = list(size = 7),  name = 'Treshold 0.50')


plot_ly( data = resultDFweek, x = Period, y = ~Return2, type = "scatter", mode = "markers", marker = list(size = 7), name = 'Treshold 0.10') %>%
  layout(xaxis = x, yaxis = y, title = 'One week deployment period')%>% 
  add_trace(data = resultDFweek, x = Period, y = ~Return, type = "scatter", mode = "markers", marker = list(size = 7),  name = 'Treshold 0.01')%>% 
  add_trace(data = resultDFweek, x = Period, y = ~Return3, type = "scatter", mode = "markers", marker = list(size = 7),name = 'Treshold 0.20')%>% 
  add_trace(data = resultDFweek, x = Period, y = ~Return4, type = "scatter", mode = "markers", marker = list(size = 7),  name = 'Treshold 0.50')


plot_ly( data = resultDFtwoweek, x = Period, y = ~Return2, type = "scatter", mode = "markers", marker = list(size = 7), name = 'Treshold 0.10') %>%
  layout(xaxis = x, yaxis = y,title = 'two weeks deployment period')%>% 
  add_trace(data = resultDFtwoweek, x = Period, y = ~Return, type = "scatter", mode = "markers", marker = list(size = 7),  name = 'Treshold 0.01')%>% 
  add_trace(data = resultDFtwoweek, x = Period, y = ~Return3, type = "scatter", mode = "markers", marker = list(size = 7),name = 'Treshold 0.20')%>% 
  add_trace(data = resultDFtwoweek, x = Period, y = ~Return4, type = "scatter", mode = "markers", marker = list(size = 7),  name = 'Treshold 0.50')

plot_ly( data = month, x = Period, y = ~Return2, type = "scatter", mode = "markers", marker = list(size = 7), name = 'Treshold 0.10') %>%
  layout(xaxis = x, yaxis = y,title = 'One month deployment period')%>% 
  add_trace(data = month, x = Period, y = ~Return, type = "scatter", mode = "markers", marker = list(size = 7),  name = 'Treshold 0.01')%>% 
  add_trace(data = month, x = Period, y = ~Return3, type = "scatter", mode = "markers", marker = list(size = 7),name = 'Treshold 0.20')%>% 
  add_trace(data = month, x = Period, y = ~Return4, type = "scatter", mode = "markers", marker = list(size = 7),  name = 'Treshold 0.50')

plot_ly( data = twomonth, x = Period, y = ~Return2, type = "scatter", mode = "markers", marker = list(size = 7), name = 'Treshold 0.10') %>%
  layout(xaxis = x, yaxis = y,title = 'two months deployment period')%>% 
  add_trace(data = twomonth, x = Period, y = ~Return, type = "scatter", mode = "markers", marker = list(size = 7),  name = 'Treshold 0.01')%>% 
  add_trace(data = twomonth, x = Period, y = ~Return3, type = "scatter", mode = "markers", marker = list(size = 7),name = 'Treshold 0.20')%>% 
  add_trace(data = twomonth, x = Period, y = ~Return4, type = "scatter", mode = "markers", marker = list(size = 7),  name = 'Treshold 0.50')
