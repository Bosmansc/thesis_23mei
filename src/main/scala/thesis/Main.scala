...
object Main {
  def main(args: Array[String]) {
    ...
    properties.setProperty("group.id", "stock5")

    val stream: DataStream[StockQuotes] = env.addSource(new FlinkKafkaConsumer08[String]("stock5", new SimpleStringSchema(), properties))
